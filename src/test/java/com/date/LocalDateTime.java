 ...
 * @author wh
 * @date 2020/7/30
 * Description:java8实现的处理时间工具类（收藏）
 */
public class LocalDateTime {
    ...
    public static String getNowTime_EN() {
        ...
        return java.time.LocalDateTime.now().format(yyyyMMddHHmmss_EN);
    }

    /** 获取当前时间（yyyy-MM-dd HH） */
    public static String getNowTime_EN_yMdH() {
        return java.time.LocalDateTime.now().format(yyyyMMddHH_EN);
    }

    /** 获取当前时间（yyyy年MM月dd日） */
    public static String getNowTime_CN_yMdH() {
        return java.time.LocalDateTime.now().format(yyyyMMddHH_CN);
    }

    /** 获取当前时间（yyyy-MM-dd HH:mm） */
    public static String getNowTime_EN_yMdHm() {
        return java.time.LocalDateTime.now().format(yyyyMMddHHmm_EN);
    }

    /** 获取当前时间（yyyy年MM月dd日HH时mm分） */
    public static String getNowTime_CN_yMdHm() {
        return java.time.LocalDateTime.now().format(yyyyMMddHHmm_CN);
    }

    /** 获取当前时间（HH时mm分ss秒） */
    public static String getNowTime_CN_HHmmss() {
        return java.time.LocalDateTime.now().format(HHmmss_CN);
    }
    ...
    public static String getTime(String formatStr) {
        return java.time.LocalDateTime.now().format(DateTimeFormatter.ofPattern(formatStr));
    }
    ...
    public static String getNowTime_CN() {
        return java.time.LocalDateTime.now().format(yyyyMMddHHmmss_CN);
    }
    ...
    public static String getNowLocalTime_shot() {
        return java.time.LocalDateTime.now().format(shotDate);
    }
    ...
    public static String getNowLocalTime_full() {
        return java.time.LocalDateTime.now().format(fullDate);
    }
    ...
    public static String getNowLocalTime_long() {
        return java.time.LocalDateTime.now().format(longDate);
    }
    ...
    public static String getNowLocalTime_medium() {
        return java.time.LocalDateTime.now().format(mediumDate);
    }
